...
namespace Kentor.AuthServices.Saml2P.EncryptedAssertion
{
    class Saml2EncryptedAssertion
    {
        ...
        /// If the certificate is not found, then an <see cref="CertificatePrivateKeyNotFoundException"/> is thrown.
        /// If the certificate is found, but a private key is not available, then an 
        /// <see cref="CertificateNotFoundException" /> is thrown.
        /// </returns>
